...
"Step 4: Click on div  -> Navigate to page 'bills/*'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC26-Verify Page Bills after Logging in at Page Frequent Projects_visual_checkpoint')
