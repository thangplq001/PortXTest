...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-projects/button_4'))

'Step 14: At Page frequent-projects, click on div object'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-projects/div_object_2'))

'Step 15: At Page frequent-projects, click on i object'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-projects/i_object_3'))

'Step 16: At Page frequent-projects, click on hyperlink admin'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-projects/hyperlink_admin'))

'Step 17: Add visual checkpoint at Page frequent-projects'

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Verify Page Frequent Projects after Performing Multiple Actions_visual_checkpoint')
