...
"Step 9: Click on input field 'frequent-project-session-name'"
...
"Step 11: Click on button '\u30b7\u30fc\u30c8\u306e\u8ffd\u52a0'"

WebUI.takeScreenshot()

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_frequent_projects/button_10'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/frequent-projects/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent_projects/button_10'))

"Step 12: Click on input field 'frequent-project-session-name'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC31-Verify Frequent Projects at Spot Projects_visual_checkpoint')
