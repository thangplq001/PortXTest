...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_spot-projects/hyperlink'))

'Step 12: Add visual checkpoint at Page spot-template-default-items'

WebUI.takeFullPageScreenshotAsCheckpoint('TC20-Verify Page Spot Template Default Items_visual_checkpoint')
