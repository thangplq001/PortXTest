...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-projects/button_5'))

'Step 15: Add visual checkpoint at Page frequent-projects'

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Verify Page Frequent Projects after Performing Specific Actions_visual_checkpoint')
