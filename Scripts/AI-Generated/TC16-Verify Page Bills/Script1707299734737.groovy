...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-projects_edit/button'))

'Step 13: At Page frequent-projects edit, click on hyperlink > navigate to Page bills'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-projects_edit/hyperlink'))

'Step 14: Add visual checkpoint at Page bills'

WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Verify Page Bills_visual_checkpoint')
