...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-project-comparisons/button'))

'Step 20: Add visual checkpoint at Page frequent-project-comparisons'

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Verify Page Frequent Project Comparisons_visual_checkpoint')
