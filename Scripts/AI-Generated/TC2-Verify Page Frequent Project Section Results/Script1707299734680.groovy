...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-projects/button_11'))

'Step 18: At Page frequent-project-section-results, click on button'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-project-section-results/button'))

'Step 19: At Page frequent-project-section-results, click on select comparison chart'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-project-section-results/select_comparison_chart'))

'Step 20: At Page frequent-project-section-results, click on button'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-project-section-results/button_1'))

'Step 21: At Page frequent-project-section-results, click on input object'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-project-section-results/input_object'))

'Step 22: At Page frequent-project-section-results, click on button'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-project-section-results/button_2'))

'Step 23: Add visual checkpoint at Page frequent-project-section-results'

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Verify Page Frequent Project Section Results_visual_checkpoint')
