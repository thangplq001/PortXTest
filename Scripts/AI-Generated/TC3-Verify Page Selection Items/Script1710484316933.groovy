...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_selection_items/div_object_3'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/selection-items?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_selection_items/div_object_3'))

"Step 9: Click on button ' \u4f5c\u6210'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Page Selection Items_visual_checkpoint')
