...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-projects/input_object_3'))

'Step 19: At Page frequent-projects, click on button'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-projects/button_10'))

'Step 20: Add visual checkpoint at Page frequent-projects'

WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Verify Page Frequent Projects_visual_checkpoint')
