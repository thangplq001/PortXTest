...
"Step 8: Click on td  -> Navigate to page 'bills/*'"

WebUI.takeScreenshot()

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_bills/td_object'), 20, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC32-Verify Bills at Frequent Projects_visual_checkpoint')
