...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-projects/div_object_3'))

'Step 19: At Page frequent-project-suppliers, click on button ngb nav 19'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-project-suppliers/button_ngb_nav_19'))

'Step 20: At Page frequent-project-suppliers, click on button'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-project-suppliers/button'))

'Step 21: At Page frequent-project-suppliers, click on button object'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-project-suppliers/button_object'))

'Step 22: At Page frequent-project-suppliers, click on button'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-project-suppliers/button_1'))

'Step 23: Add visual checkpoint at Page frequent-project-suppliers'

WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Verify Page Frequent Project Suppliers_visual_checkpoint')
