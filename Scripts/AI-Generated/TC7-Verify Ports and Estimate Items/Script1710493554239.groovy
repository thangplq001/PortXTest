...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_estimate_items/div_object_1'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/estimate-items?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_estimate_items/div_object_1'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Verify Ports and Estimate Items_visual_checkpoint')
