...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_frequent-projects/i_object_2'))

'Step 14: Add visual checkpoint at Page frequent-projects'

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Verify Page Frequent Projects after Specific Actions_visual_checkpoint')
